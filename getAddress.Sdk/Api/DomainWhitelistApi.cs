...
namespace getAddress.Sdk.Api
{
    public class DomainWhitelistApi : AdminApiBase
    {
        ...
        public async  Task<AddDomainWhitelistResponse> Remove(RemoveDomainWhitelistRequest request)
        {
            return await Remove(Api, request, Path, AdminKey);
        }

        public async static Task<AddDomainWhitelistResponse> Remove(GetAddesssApi api, RemoveDomainWhitelistRequest request, string path, AdminKey adminKey)
        {
            if (api == null) throw new ArgumentNullException(nameof(api));
            if (request == null) throw new ArgumentNullException(nameof(request));
