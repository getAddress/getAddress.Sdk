...
{
    public class PaymentFailedEmailNotificationApi : AdminApiBase
    {
        public const string Path = "email-notification/payment-failed/";

        internal PaymentFailedEmailNotificationApi(AdminKey adminKey, GetAddesssApi api) : base(adminKey, api)
        {
