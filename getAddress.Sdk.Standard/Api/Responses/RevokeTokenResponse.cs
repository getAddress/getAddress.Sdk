...
{
    public abstract class RevokeTokenResponse : ResponseBase<
        RevokeTokenResponse.Success, 
        RevokeTokenResponse.Failed,  
        RevokeTokenResponse.TokenExpired,
        RevokeTokenResponse.RateLimitedReached,
        RevokeTokenResponse.Forbidden>
    {
