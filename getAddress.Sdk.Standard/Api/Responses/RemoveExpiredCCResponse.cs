...
{
    public abstract class RemoveExpiredCCResponse : ResponseBase<
        RemoveExpiredCCResponse.Success, 
        RemoveExpiredCCResponse.Failed, 
        RemoveExpiredCCResponse.TokenExpired,
        RemoveExpiredCCResponse.RateLimitedReached,
        RemoveExpiredCCResponse.Forbidden>
    {
