...
{
    public class SecondLimitReachedEmailNotificationApi : AdminApiBase
    {
        public const string Path = "email-notification/monthly-limit-reached/";

        internal SecondLimitReachedEmailNotificationApi(AdminKey adminKey, GetAddesssApi api) : base(adminKey, api)
        {
