...
{
    public class FirstLimitReachedEmailNotificationApi : AdminApiBase
    {
        public const string Path = "email-notification/daily-limit-reached/";

        internal FirstLimitReachedEmailNotificationApi(AdminKey adminKey, GetAddesssApi api) : base(adminKey, api)
        {
